package com.yzspp.sewage.view.bottomdialog;
...
import com.yzspp.sewage.view.ForbidQuickClickListener;
...
public class BottomDialog {
    ...
    public BottomDialog setData(AMapLocation myLocation, NearbyBumpBean parkingMineBean) {
...
//            });
        ...
        public void setData(AMapLocation myLocation, NearbyBumpBean parkingMineBean) {
        ...
        private class DialogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            class LeftHolder extends RecyclerView.ViewHolder {
                ...
                LeftHolder(View view) {
                    ...
                    item.setTextColor(ContextCompat.getColor(view.getContext(), R.color.accent_black));
