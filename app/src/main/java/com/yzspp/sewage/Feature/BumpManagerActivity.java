...
import com.yzspp.sewage.Discover.ReportSituationActivity;
import com.yzspp.sewage.Discover.WeatherActivity;
...
public class BumpManagerActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_bump_manager;
    }

    @Override
    protected void initView() {
        initToolbar("泵站信息管理", true);
        ...
        this.dvupload = (DiscoverView) findViewById(R.id.dv_upload);
        initIcon();
...
//                WeatherActivity.start(BumpManagerActivity.this);
    ...
    protected void initData() {
        mAdapter = new SolidRVBaseAdapter<UploadInfo>(BumpManagerActivity.this, mUploadInfoList) {
            @Override
            ...
            protected void onItemClick(int position, UploadInfo bean) {
                ...
                CheckDetailsActivity.start(BumpManagerActivity.this, bean);
            }
        };
        loadWetPoints();
    }
    ...
    protected void setData() {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(BumpManagerActivity.this) {
            @Override
