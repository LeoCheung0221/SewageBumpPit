package com.yzspp.sewage.widget.boommenu.BoomButtons;
...
import com.yzspp.sewage.widget.boommenu.BMBShadow;
import com.yzspp.sewage.widget.boommenu.ButtonEnum;
import com.yzspp.sewage.widget.boommenu.Util;
...
public abstract class BoomButton extends FrameLayout {
    ...
    protected Rect imageSmallRect = null;
    ...
    protected void initAttrs(BoomButtonBuilder builder) {
        ...
        imageSmallRect = builder.imageSmallRect;
    ...
    protected void initSmallImage() {
        image = new ImageView(context);
        updateSmallImageRect();
        updateImagePadding();
        button.addView(image);
        lastStateIsNormal = false;
        toNormal();
    ...
    void updateSmallImageRect() {
        LayoutParams params = new LayoutParams(
                imageSmallRect.right - imageSmallRect.left,
                imageSmallRect.bottom - imageSmallRect.top);
        params.leftMargin = imageSmallRect.left;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1)
            params.setMarginStart(imageSmallRect.left);
        params.topMargin = imageSmallRect.top;
        if (image != null) image.setLayoutParams(params);
    }
