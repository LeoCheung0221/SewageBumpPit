...
public abstract class BoomButtonBuilder<T> {
    ...
    Rect imageSmallRect = new Rect(Util.dp2px(10), Util.dp2px(10), Util.dp2px(50), Util.dp2px(70));
    ...
    public T imageSmallRect(Rect imageRect) {
        if (this.imageSmallRect != imageRect) {
            this.imageSmallRect = imageRect;
            BoomButton button = button();
            if (button != null) {
                button.imageSmallRect = imageRect;
                button.updateImageRect();
            }
        }
        return (T) this;
